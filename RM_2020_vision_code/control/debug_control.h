...
/*---------------------------------------------------*/
#define PB_MODEL_PATH "./RM_2020_vision_code-1/py/model/CNN_model1.pb"
/**
  @brief: tensorflow模型路径
  @param: PB_MODEL_PATH pb文件路径
*/

#define CAMERA_PARAM_FILE "./RM_2020_vision_code-1/camera/param/cameraParams_infantry4.xml"
/**
  @brief: 相机标定文件路径
*/
/*---------------------------------------------------*/
