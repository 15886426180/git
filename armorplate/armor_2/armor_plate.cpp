...
// {
//     VideoCapture capture("/home/xx/下载/效果图/armor_1.avi");
//     if (!capture.isOpened())
//     {
//         cout << "无法打开相机..." << endl;
//     }
...
//         if (armor_width > light[i].size.width && armor_width > light[j].size.width && armor_width < (light[i].size.height + light[j].size.height) * 2)
//         {
